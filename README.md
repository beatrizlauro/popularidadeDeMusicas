...
O trabalho propõe a aplicação de técnicas de **ETL**, **análise exploratória**, **modelagem preditiva** e **interpretação de resultados**, utilizando o conjunto de dados **Spotify Tracks Dataset**, disponível publicamente no Kaggle.  
...
## 🧠 Justificativa
Com o crescimento das plataformas de streaming e o volume crescente de dados musicais disponíveis, compreender os fatores que influenciam a popularidade de uma música tornou-se fundamental para artistas, gravadoras e serviços de recomendação.  
O projeto busca unir a análise técnica com um contexto cultural e criativo, promovendo uma visão mais ampla do papel dos dados no entretenimento.
...
**Fonte:** [Kaggle – Ultimate Spotify Tracks DB](https://www.kaggle.com/datasets/zaheenhamidani/ultimate-spotify-tracks-db)  
...
**Tipo de Problema:**  
Regressão (prever o valor numérico da popularidade)  
ou  
Classificação (categorizar músicas como “populares” ou “não populares”).
...
- Identificação das variáveis com maior influência na popularidade.  
- Criação de visualizações que evidenciem padrões musicais relevantes.  
- Desenvolvimento de um modelo preditivo com bom desempenho (ex: R² ≥ 0.70).  
